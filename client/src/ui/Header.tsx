...
import { logo } from "../assets/footerIcons";
   ...
   <div className="w-full bg-whiteText md-sticky md:top-0 z-50">
    <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between px-4 py-4 gap-3">
      ...
      <Link to={"/favorite"} className="relative block ">
        ...
        <span className="inline flex items-center justify-center bg-redText text-whiteText absolute -top-2 -right-2 text-[9px] rounded-full w-4 h-4">

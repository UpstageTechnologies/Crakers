        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-10">
          ...
          <div className="text-start flex-1">
            ...
            <p className="text-start *:mt-6 max-w-3xl text-base mt-3 leading-6 text-gray-300">
              Welcome to Crackers Shope! We're delighted to have you here. Explore our wide range of premium fireworks, enjoy exclusive offers, and manage your orders with ease. Have a safe and joyful celebration!
            </p>
          </div>
        </div>
